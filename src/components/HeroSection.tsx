    ...
    >
      ...
      <Container className="relative z-10 flex min-h-[92vh] items-center justify-center px-4">
        <div className="w-full max-w-6xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="mx-auto max-w-[16ch] text-[36px] sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight">
          ...
          <p className="mt-6 mx-auto max-w-3xl text-lg sm:text-xl text-gray-800 leading-relaxed">
          ...
          <div className="mt-10 grid w-full max-w-5xl mx-auto grid-cols-1 sm:grid-cols-3 gap-4">
