...
export class SchemaGenerator {
  ...
  static generateMedicalOrganizationSchema(): MedicalOrganizationSchema {
    return {
      ...
      description: "Asia-Pacific's leading colorectal cancer screening advocacy movement. We empower communities through early detection, education, and innovative screening technologies across Singapore, India, Philippines, Australia, and Japan.",
