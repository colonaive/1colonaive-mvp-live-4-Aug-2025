            ...
            <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-2xl p-8 mb-12 border border-blue-100">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-700 font-medium">
                  More than just a name, it reflects our mission.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-teal-600 to-orange-500 text-white rounded-lg shadow-md overflow-hidden">
                <div className="p-8 text-center">
                  ...
                  <p className="text-orange-100">
                    Screening and polyp removal can occur within the same procedure, which makes colonoscopy central to prevention.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              A Singapore where colorectal cancer is no longer a life-threatening disease, supported by screening,
              timely referral to colonoscopy, early detection, and coordinated national action.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 bg-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              This is why Project COLONAiVE™ is built on five interconnected pillars. Together they form a
              nationwide movement in which every stakeholder has a role to play:
            </p>
