...
import { BookOpen, Users, Shield, ArrowRight, Globe, Heart, AlertCircle, CheckCircle, TrendingUp, Building } from 'lucide-react';
...
const JapanCRCEducation: React.FC = () => {
  ...
  const hreflangTags = HreflangGenerator.generateHreflangTags(
    ...
    currentLanguage,
    'Japan',
    'colorectal cancer education japan'
  );

  const content = {
    ja: {
      title: '日本における大腸がんを理解する',
      subtitle: '日本人に向けた大腸がんの予防、検診、早期発見に関する総合的な教育',
      crc101: {
        title: '大腸がん基礎知識：大腸がんを理解する',
        whatIs: {
          title: '大腸がんとは何ですか？',
          content: '大腸がん（CRC）は、大腸の一部である結腸または直腸に発生します。日本では大腸がんは最も診断されるがんで、年間14万7000人以上の新規患者が発生しています。'
        },
        progression: {
          title: 'ポリープからがんへ：大腸がんの発達過程',
          content: 'ほとんどの大腸がんは、ポリープと呼ばれる小さな成長物から始まります。5〜10年にわたって、一部のポリープががんになることがあります。定期的な検診により、ポリープががんになる前に発見・除去することができます。'
        },
        screening: {
          title: '日本で早期検診が重要な理由',
          content: '日本の高齢化社会に伴い、今後10年間で大腸がんの症例は15％増加すると予想されています。国の検診プログラムへの参加率は45％にとどまり、WHO推奨値を下回っています。'
        }
      },
      localStats: {
        title: '日本の大腸がん：主要統計',
      ...
      nationalSystem: {
        title: '国民健康保険制度と検診',
        content: '日本の国民健康保険制度は基本的な大腸がん検診をカバーしていますが、高度な血液ベースの検査はより高い精度と利便性を提供します。',
        coverage: '便潜血検査は国民健康保険でカバーされ、年1回の検診が推奨されています。血液ベースの検査は自費診療となりますが、高い精度を提供します。',
        facilities: '全国の主要病院やクリニックで検診が利用可能で、47都道府県すべてで検診サービスが提供されています。'
      },
      cta: {
        title: '今すぐ行動を起こしましょう',
        subtitle: '早期発見が命を救います。日本全国の検診オプションを見つけてください。',
        buttons: {
          clinic: '検診センターを探す',
          bloodTest: '血液検査を予約',
          specialist: '専門医に相談'
    ...
    en: {
      ...
      subtitle: 'Comprehensive education about colorectal cancer prevention, screening, and early detection tailored for Japan',
      crc101: {
        title: 'CRC 101: Understanding Colorectal Cancer',
        whatIs: {
          title: 'What is Colorectal Cancer?',
          content: 'Colorectal cancer (CRC) develops in the colon or rectum, parts of the large intestine. In Japan, CRC is the most diagnosed cancer, with over 147,000 new cases annually.'
        },
        progression: {
        ...
        screening: {
          ...
          content: 'With Japan\'s aging society, CRC cases are expected to increase by 15% over the next decade. National screening program participation remains at only 45%, below WHO recommendations.'
        }
      },
      localStats: {
      ...
      nationalSystem: {
        ...
        content: 'Japan\'s National Health Insurance covers basic CRC screening, but advanced blood-based testing provides enhanced accuracy and convenience.',
        coverage: 'Fecal occult blood tests are covered by NHI with annual screening recommended. Blood-based tests are typically self-pay but offer higher accuracy.',
        facilities: 'Screening is available at major hospitals and clinics nationwide, with services provided across all 47 prefectures.'
      },
      cta: {
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-lg p-8 text-center">
                <div className="w-full h-64 bg-red-100 rounded-lg flex items-center justify-center mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-red-600 font-medium">大腸・ポリープ発達図 / Colon & Polyp Development Diagram</p>
              ...
              <div className="mt-12 pt-8 border-t border-red-700">
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                  <a href="/education/patients/colorectal-cancer" className="text-red-200 hover:text-white underline">
                    {currentLanguage === 'ja' ? '大腸がんを理解する' : 'Understanding Colorectal Cancer'}
                  </a>
