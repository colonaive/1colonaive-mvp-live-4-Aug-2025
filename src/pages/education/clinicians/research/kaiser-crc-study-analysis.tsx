      ...
      <div>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
          ...
          <ul className="space-y-2 text-blue-800">
            <li>Screening participation rose from <strong>37.4% to 79.8%</strong> over a decade</li>
            <li>Colorectal cancer incidence <strong>fell by approximately one third</strong></li>
            <li>CRC-specific mortality <strong>fell by approximately one half</strong></li>
            <li>Screening disparities <strong>narrowed across racial and ethnic groups</strong></li>
          </ul>
        </div>
        ...
        <p>
          ...
          blood in the stool, a potential early indicator of colorectal neoplasia. By removing common barriers to
          screening &mdash; such as the need to schedule a clinic visit, take time off work, or undergo bowel
          preparation &mdash; the mailed FIT approach made it substantially easier for individuals to participate.
        </p>
        <p>
        ...
        <p>
          ...
          This increase is notable because it occurred across a large, diverse, real-world population &mdash; not
        ...
        <p>
          ...
          different populations. The systematic, population-wide approach &mdash; which did not depend on individual
          patients initiating their own screening &mdash; helped close these gaps more effectively than traditional
        ...
        <p>
          ...
          effective screening tools &mdash; including stool-based tests, colonoscopy, and emerging blood-based
          approaches &mdash; but struggle with uptake. The evidence from Kaiser Permanente demonstrates that
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-1">
                ...
                was not incidental &mdash; it was a direct consequence of reaching all eligible members through
        ...
        <p>
          ...
          their baseline levels &mdash; and in doing so, demonstrated approximately a one-third reduction in
        ...
        <p>
          ...
          operational detail &mdash; it is the primary determinant of whether a screening programme will
