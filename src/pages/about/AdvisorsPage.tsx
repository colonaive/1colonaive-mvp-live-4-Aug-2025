...
const advisors = [
  ...
  },
  {
    ...
    bio:
      "Prof. Shabbir Moochhala is a highly respected pharmacologist and biomedical researcher serving as Adjunct Associate Professor at NUS, with a distinguished career in translational research, defence medicine, and biotech innovation. He has led pioneering work in microbiome therapeutics, novel drug delivery systems, and molecular diagnostics, and holds leadership roles including Chairman of GRAIN International and Director of Chemtron and Fifthsense. Prof. Moochhala’s prolific contributions include over 220 publications, several patents and book chapters, and he is widely recognized for advancing healthcare solutions from laboratory to real-world impact, while guiding scientific and industry initiatives in Singapore.",
