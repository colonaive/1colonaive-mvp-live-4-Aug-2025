        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-0">
              Choose the screening option that suits you best, whether that is a blood test or colonoscopy. Early action saves lives.
            </p>
          </div>
        </Container>
      </div>
          ...
          <Card className="bg-blue-50 border-l-4 border-blue-600">
            <CardContent className="p-8">
              <div className="max-w-3xl mx-auto text-gray-800 text-lg leading-relaxed space-y-4">
                ...
                <p>
                  If you are not due for a colonoscopy, or if you are younger but have risk factors, a blood-based
                  screening test may be appropriate. It offers a non-invasive first step for selected patients.
                </p>
              </div>
            </CardContent>
          </Card>
