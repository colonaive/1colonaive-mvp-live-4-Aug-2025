            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Are You Eligible for Screening in India?
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Take our personalized assessment to determine if you should get screened for colorectal cancer in India. 
                  Get recommendations based on ICMR guidelines and your individual risk profile.
                </p>
              </div>
