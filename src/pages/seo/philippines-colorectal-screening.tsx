            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Kailangan Mo Ba Mag-Screening? | Do You Need Screening in Philippines?
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Take our personalized assessment para malaman kung kailangan mo ng colorectal cancer screening sa Pilipinas. 
                  Get recommendations based on DOH guidelines and your individual risk profile.
                </p>
              </div>
