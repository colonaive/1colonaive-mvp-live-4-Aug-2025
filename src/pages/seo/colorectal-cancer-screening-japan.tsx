  ...
  return (
    <>
      ...
      <div className="pt-20 min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-red-900 via-red-700 to-pink-600 text-white py-16">
          <Container>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto">
                With CRC now the most diagnosed cancer in Japan, see what screening options are available under national guidelines.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-start">
                      ...
                      <p>
                        <strong>Most Common Cancer:</strong> Colorectal cancer is now the most 
                        frequently diagnosed cancer in Japan, with over 150,000 new cases annually.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>National Program:</strong> Japan has a comprehensive national 
                        screening program with FOBT testing for citizens aged 40+.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>High Screening Rates:</strong> Japan achieves 75% screening 
                        participation, one of the highest rates globally.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>Aging Population:</strong> With rapid population aging, CRC 
                        cases continue to rise despite screening efforts.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Screening Options in Japan</h3>
                  <div className="space-y-6">
                    <div className="border-l-4 border-red-500 pl-4">
                      <h4 className="font-semibold text-gray-900">Blood-Based Test (Premium)</h4>
                      <p className="text-gray-600 text-sm mt-1">
                        Advanced screening with 94% accuracy, no preparation required
                      </p>
                      <p className="text-red-600 font-medium mt-2">¥25,000 - ¥40,000</p>
                    </div>
                    
                    <div className="border-l-4 border-blue-500 pl-4">
                      <h4 className="font-semibold text-gray-900">FOBT (National Program)</h4>
                      <p className="text-gray-600 text-sm mt-1">
                        Free annual screening through municipal programs
                      </p>
                      <p className="text-blue-600 font-medium mt-2">Free (Ages 40+)</p>
                    </div>
                    
                    <div className="border-l-4 border-purple-500 pl-4">
                      <h4 className="font-semibold text-gray-900">Colonoscopy</h4>
                      <p className="text-gray-600 text-sm mt-1">
                        Comprehensive exam covered by national health insurance
                      </p>
                      <p className="text-purple-600 font-medium mt-2">¥30,000 - ¥60,000</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="bg-pink-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700">National screening participation rate</p>
                </div>
                <div className="bg-purple-50 rounded-lg p-6">
                  <div className="text-3xl font-bold text-purple-600 mb-2">40+</div>
                  <p className="text-gray-700">National screening age</p>
                </div>
              </div>
            </div>
          </Container>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Check Your Risk for CRC in Japan
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Take our personalized assessment to determine if you're eligible for colorectal cancer screening in Japan. 
                  Get recommendations based on national guidelines and your individual risk profile.
                </p>
              </div>
        ...
        {/* CTA Section */}
        <section className="py-16 bg-gradient-to-r from-red-800 to-pink-700 text-white">
          <Container>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-red-100 mb-8">
                ...
                Complement your national screening with advanced blood testing.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/find-clinic">
                  <Button size="lg" className="bg-white text-red-800 hover:bg-gray-100">
              ...
              <div className="mt-12 pt-8 border-t border-red-700">
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                  <a href="/coming-soon/japan" className="text-red-200 hover:text-white underline">
                    Japan CRC Education
                  </a>
                  <a href="/education/patients/colorectal-cancer" className="text-red-200 hover:text-white underline">
                    Understanding Colorectal Cancer
                  </a>
                  <a href="/find-clinic" className="text-red-200 hover:text-white underline">
                    Get Screened
                  </a>
...
export default ColorectalCancerScreeningJapan;