          ...
          <Container>
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Colorectal Cancer Screening in the Philippines
              </h1>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Colorectal cancer is now a top killer in the Philippines. See how screening can save lives through early detection.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="flex items-start">
                      ...
                      <p>
                        <strong>Top Cancer Killer:</strong> Colorectal cancer is now the third most 
                        common cancer and second leading cause of cancer deaths in the Philippines.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>Rising Incidence:</strong> Cases have increased by 50% over the past 
                        15 years, with younger patients being affected.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>Screening Gap:</strong> Less than 15% of eligible Filipinos undergo 
                        regular CRC screening due to limited awareness and access.
                      </p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
                      <p>
                        <strong>Late Diagnosis:</strong> 80% of cases are diagnosed at advanced stages 
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Screening Options in the Philippines</h3>
                  <div className="space-y-6">
                    <div className="border-l-4 border-blue-500 pl-4">
                      ...
                      <p className="text-blue-600 font-medium mt-2">₱8,000 - ₱18,000</p>
                    </div>
                    ...
                    <div className="border-l-4 border-yellow-500 pl-4">
                      ...
                      <p className="text-yellow-600 font-medium mt-2">₱800 - ₱2,000</p>
                    </div>
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      ...
                      <p className="text-purple-600 font-medium mt-2">₱25,000 - ₱50,000</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Check Your Risk for CRC in the Philippines
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Take our personalized assessment to determine if you're eligible for colorectal cancer screening in the Philippines. 
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-12 pt-8 border-t border-blue-700">
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                  ...
                  <a href="/find-clinic" className="text-blue-200 hover:text-white underline">
                    Get Screened
                  </a>
...
export default ColorectalCancerScreeningPhilippines;