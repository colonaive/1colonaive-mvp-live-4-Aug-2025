# COLONAiVE Master Document Index
> Generated: 2026-03-13
> Source: OneDrive audit of COLONAiVE / ColonAiQ / Saver's Med documents
...
|----------|--------|-------------|
| Business Plan for ColonAiQ.docx | DOCX | Core business plan for ColonAiQ commercialization |
| COLONAiVE Feature Roadmap & Deployment Tracker 26 April 2025.docx | DOCX | Product roadmap and feature deployment tracking |
| ColonAiQ Workplan for India, Singapore & Philippines Oct 2023.pdf | PDF | Multi-market workplan and timeline |
| ColonAiQ_Strategic_Briefing.pptx | PPTX | Strategic briefing presentation |
| Project COLONAiVE Contingency Report 6 May 2025.docx | DOCX | Risk contingency and fallback planning |
| Project COLONAiVE Overview Update 18 April 2025.docx | DOCX | Project status overview |
| Project COLONAiVE Strategic Snapshot 25 April 2025.pdf | PDF | Executive strategic snapshot |
| Project_COLONAiVE_Overview_and_Pillars.docx | DOCX | Movement pillars and structural overview |
| Project_COLONAiVE_Positioning_Consolidation 23 April 2025.docx | DOCX | Brand and market positioning consolidation |
...
| Document | Format | Description |
|----------|--------|-------------|
| Clinical Value and Utility of ColonAiQ - for CCA Logo.pptx | PPTX | Clinical value deck (CCA branded) |
| Clinical Value and Utility of ColonAiQ.pptx | PPTX | Clinical value and utility presentation |
| ColonAiQ Instructional Manual.docx | DOCX | Product instructional manual |
...
| PreC Study Update Sept 2023 Annals of Oncology.pdf | PDF | PreC study interim results |
...
| Document | Format | Description |
|----------|--------|-------------|
| CE Certificate - Multi-Gene Methylation Detection Kit.pdf | PDF | CE IVDD marking certificate |
| ColonAiQ HSA Device Licence CE & NMPA.pdf | PDF | HSA licence referencing CE and NMPA |
| ColonAiQ HSA Device Licence Exp 10 Apr 2026.pdf | PDF | Current HSA device licence (expires 10 Apr 2026) |
| ColonAiQ HSA Public Enquiry DE0510590.pdf | PDF | HSA public register entry |
| Dutch Notification of IVD - 6 Dec 2021 Eng Translated.pdf | PDF | EU IVD notification (Netherlands) |
| IVDD-Singlera-ColonAiQ CE Technical Files 1.pdf | PDF | CE technical file documentation |
| India Importing Overview (Detailed View).pdf | PDF | India import regulatory pathway detail |
| India Regulatory Overview - Asia Actual Jan 2025.pdf | PDF | India regulatory landscape assessment |
| March REGULATORY ASSESSMENT of ColonAiQ.pdf | PDF | Comprehensive regulatory assessment |
...
| Document | Format | Description |
|----------|--------|-------------|
| ColonAiQ 2-step screening Email to Health Ministers.docx | DOCX | Government outreach correspondence |
...
| Document | Format | Description |
|----------|--------|-------------|
| ColonAiQ Brochure SG 3 Dec 2024.pdf | PDF | Singapore market patient/clinician brochure |
...
| Document | Format | Description |
|----------|--------|-------------|
| ColonAiQ Business Summary - Mar 2025.pdf | PDF | Executive business summary |
| ColonAiQ Pitch Deck PSF SG PH IN 12 Apr 2025.pdf | PDF | Investor pitch deck (PDF) |
| ColonAiQ Pitch Deck PSF SG PH IN 12 Apr 2025.pptx | PPTX | Investor pitch deck (editable) |
...
## NotebookLM Ingestion Set (23 documents)

Location: `C:\COLONAiVE_MASTER_KB\NOTEBOOKLM_READY\`

Selected for highest strategic and informational density:
- Business Plan for ColonAiQ.docx
- Project COLONAiVE Strategic Snapshot 25 April 2025.pdf
- Project_COLONAiVE_Overview_and_Pillars.docx
- ColonAiQ_Strategic_Briefing.pptx
- Project_COLONAiVE_Positioning_Consolidation 23 April 2025.docx
- Clinical Value and Utility of ColonAiQ.pptx
- IFU FINAL.docx
- Workflow introduction of ColonAiQ 23 April 2025.pdf
- ColonAiQ_Presention 20251212.pptx
- A Multilocus Blood-Based Assay (Gastroenterology 2021).pdf
- Early Detection of MRD (JAMA Oncology 2023).pdf
- Clinical Evidence Brief for COLONAiVE.pdf
- SMART_CRC_SG_Protocol_Synopsis_Final.docx
- Performance Evaluation of Multi-gene Methylation Kit.pdf
- ColonAiQ HSA Device Licence Exp 10 Apr 2026.pdf
- CE Certificate.pdf
- NMPA approval ID No. 20243400902.pdf
- March REGULATORY ASSESSMENT of ColonAiQ.pdf
- ColonAiQ Brochure SG 3 Dec 2024.pdf
- ColonAiQ Pitch Deck PSF SG PH IN 12 Apr 2025.pptx
- ColonAiQ Business Summary - Mar 2025.pdf
- MRA Grant Proposal - ColonAiQ.docx
- Project_COLONAiVE_Platform_Spec Updated 22 April 2025.docx
